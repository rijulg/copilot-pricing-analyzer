...
Pricing comes from [GitHub's models-and-pricing page](https://docs.github.com/en/copilot/reference/copilot-billing/models-and-pricing) and is stored in `models.js`. A daily GitHub Action (`scripts/update-models.js`) regenerates it from the source data and commits any changes.
