...
const MODELS = [
  ...
  { id: "gpt-5.6-sol", name: "GPT-5.6 Sol (≤272K)", provider: "OpenAI", tier: "Powerful", input: 4.00, cached: 0.40, cacheWrite: 0, output: 20.00 },
  { id: "gpt-5.6-sol-long", name: "GPT-5.6 Sol (>272K)", provider: "OpenAI", tier: "Powerful", input: 8.00, cached: 0.80, cacheWrite: 0, output: 30.00 },
  ...
  { id: "grok-4.7", name: "Grok 4.7 (≤200K)", provider: "xAI", tier: "Versatile", input: 2.00, cached: 0.50, cacheWrite: 0, output: 6.00 },
  { id: "grok-4.7-long", name: "Grok 4.7 (>200K)", provider: "xAI", tier: "Versatile", input: 4.00, cached: 1.00, cacheWrite: 0, output: 12.00 },
];
